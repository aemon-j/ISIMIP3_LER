...
clusterExport(clust, varlist = list("cal_tasks", "run_calib_on_core2", "add_to_report",
...
parLapply(clust, seq_len(use_cores), function(core_job) do.call(run_calib_on_core2,
